...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str,
                        default='h36m', help='dataset name')
...
def check_args(args):
    ...
    print (args.dataset)
    try:
        assert args.dataset=='h36m' or args.dataset=='mnist'
    except:
        print('Unknow datasets')
        return None
...
def main(args):
    ...
    dim_img = Num_of_Joints*3  # number of pixels for a MNIST image
    dim_z = args.dim_z
