...
flags.DEFINE_string("dataset", "h36m_nolabel", "The name of dataset [celebA, mnist, lsun, h36m,h36m_nolabel]")
flags.DEFINE_string("input_fname_pattern", "resized/*.jpg","Glob pattern of filename of input images [*]")
flags.DEFINE_string("checkpoint_dir", "checkpoint","Directory name to save the checkpoints [checkpoint]")
# flags.DEFINE_string("data_dir", "../datasets/","Root directory of dataset [data]")
flags.DEFINE_string("data_dir", "/media/a/Portable/","Root directory of dataset [data]")
